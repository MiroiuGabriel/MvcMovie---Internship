...
namespace MvcMovie.Controllers
{
    public class VideoGamesController : Controller
    {
        ...
        {
            if (_context.VideoGame is null) Problem("Entity set 'MvcMovieContext.Movie'  is null.");

            var videoGames = from s in _context.VideoGame
                         select s;
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Publisher,ReleaseDate,Price")] VideoGame videoGame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Publisher,ReleaseDate,Price")] VideoGame videoGame)
        {
            if (id != videoGame.Id)
            {
                return NotFound();
